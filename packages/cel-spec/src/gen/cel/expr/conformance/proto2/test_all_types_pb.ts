...
import { Any, BoolValue, BytesValue, DoubleValue, Duration, Empty, FieldMask, FloatValue, Int32Value, Int64Value, ListValue, Message, NullValue, proto2, protoInt64, StringValue, Struct, Timestamp, UInt32Value, UInt64Value, Value } from "@bufbuild/protobuf";
...
proto2.util.setEnumType(GlobalEnum, "cel.expr.conformance.proto2.GlobalEnum", [
  { no: 0, name: "GOO" },
  { no: 1, name: "GAR" },
  { no: 2, name: "GAZ" },
]);
...
export class TestAllTypes extends Message<TestAllTypes> {
  ...
  static readonly typeName = "cel.expr.conformance.proto2.TestAllTypes";
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 117, name: "field_mask", kind: "message", T: FieldMask, opt: true },
    { no: 118, name: "empty", kind: "message", T: Empty, opt: true },
    ...
    { no: 403, name: "nestedgroup", kind: "message", T: TestAllTypes_NestedGroup, delimited: true, opt: true },
  ]);
...
proto2.util.setEnumType(TestAllTypes_NestedEnum, "cel.expr.conformance.proto2.TestAllTypes.NestedEnum", [
  { no: 0, name: "FOO" },
  { no: 1, name: "BAR" },
  { no: 2, name: "BAZ" },
]);
...
export class TestAllTypes_NestedMessage extends Message<TestAllTypes_NestedMessage> {
  ...
  static readonly runtime: typeof proto2 = proto2;
  static readonly typeName = "cel.expr.conformance.proto2.TestAllTypes.NestedMessage";
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
 ...
 */
export class TestAllTypes_NestedGroup extends Message<TestAllTypes_NestedGroup> {
  /**
  ...
  constructor(data?: PartialMessage<TestAllTypes_NestedGroup>) {
    super();
    proto2.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto2 = proto2;
  static readonly typeName = "cel.expr.conformance.proto2.TestAllTypes.NestedGroup";
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 404, name: "single_id", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
    { no: 405, name: "single_name", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TestAllTypes_NestedGroup {
    return new TestAllTypes_NestedGroup().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TestAllTypes_NestedGroup {
    return new TestAllTypes_NestedGroup().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TestAllTypes_NestedGroup {
    return new TestAllTypes_NestedGroup().fromJsonString(jsonString, options);
  }

  static equals(a: TestAllTypes_NestedGroup | PlainMessage<TestAllTypes_NestedGroup> | undefined, b: TestAllTypes_NestedGroup | PlainMessage<TestAllTypes_NestedGroup> | undefined): boolean {
    return proto2.util.equals(TestAllTypes_NestedGroup, a, b);
  }
}
...
export class NestedTestAllTypes extends Message<NestedTestAllTypes> {
  ...
  static readonly runtime: typeof proto2 = proto2;
  static readonly typeName = "cel.expr.conformance.proto2.NestedTestAllTypes";
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
...
export class TestRequired extends Message<TestRequired> {
  ...
  static readonly runtime: typeof proto2 = proto2;
  static readonly typeName = "cel.expr.conformance.proto2.TestRequired";
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
