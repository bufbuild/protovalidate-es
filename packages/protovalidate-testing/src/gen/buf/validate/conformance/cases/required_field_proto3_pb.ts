...
export type RequiredProto3Message = Message<"buf.validate.conformance.cases.RequiredProto3Message"> & {
   ...
   */
  val?: RequiredProto3Message_Msg | undefined;
};
...
export type RequiredProto3MessageIgnoreAlways = Message<"buf.validate.conformance.cases.RequiredProto3MessageIgnoreAlways"> & {
   ...
   */
  val?: RequiredProto3MessageIgnoreAlways_Msg | undefined;
};
...
/**
 * @generated from message buf.validate.conformance.cases.RequiredImplicitProto3Scalar
 */
export type RequiredImplicitProto3Scalar = Message<"buf.validate.conformance.cases.RequiredImplicitProto3Scalar"> & {
  /**
   * @generated from field: string val = 1;
   */
  val: string;
...
/**
 * Describes the message buf.validate.conformance.cases.RequiredImplicitProto3Scalar.
 * Use `create(RequiredImplicitProto3ScalarSchema)` to create a new message.
 */
export const RequiredImplicitProto3ScalarSchema: GenMessage<RequiredImplicitProto3Scalar> = /*@__PURE__*/
  messageDesc(file_buf_validate_conformance_cases_required_field_proto3, 15);

/**
 * @generated from message buf.validate.conformance.cases.RequiredImplicitProto3Repeated
 */
export type RequiredImplicitProto3Repeated = Message<"buf.validate.conformance.cases.RequiredImplicitProto3Repeated"> & {
  /**
   * @generated from field: repeated string val = 1;
   */
  val: string[];
...
/**
 * Describes the message buf.validate.conformance.cases.RequiredImplicitProto3Repeated.
 * Use `create(RequiredImplicitProto3RepeatedSchema)` to create a new message.
 */
export const RequiredImplicitProto3RepeatedSchema: GenMessage<RequiredImplicitProto3Repeated> = /*@__PURE__*/
  messageDesc(file_buf_validate_conformance_cases_required_field_proto3, 16);

/**
 * @generated from message buf.validate.conformance.cases.RequiredImplicitProto3Map
 */
export type RequiredImplicitProto3Map = Message<"buf.validate.conformance.cases.RequiredImplicitProto3Map"> & {
  /**
   * @generated from field: map<string, string> val = 1;
   */
  val: { [key: string]: string };
...
/**
 * Describes the message buf.validate.conformance.cases.RequiredImplicitProto3Map.
 * Use `create(RequiredImplicitProto3MapSchema)` to create a new message.
 */
export const RequiredImplicitProto3MapSchema: GenMessage<RequiredImplicitProto3Map> = /*@__PURE__*/
  messageDesc(file_buf_validate_conformance_cases_required_field_proto3, 17);
