...
export type FieldRules = Message<"buf.validate.FieldRules"> & {
   ...
   * ```
   *
   * @generated from field: repeated string cel_expression = 28;
   */
  celExpression: string[];
