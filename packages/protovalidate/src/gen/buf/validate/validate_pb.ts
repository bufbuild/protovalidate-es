...
export type StringRules = Message<"buf.validate.StringRules"> & {
  ...
  wellKnown: {
     ...
     * ```
     *
     * @generated from field: buf.validate.DecimalRules decimal = 36;
     */
    value: DecimalRules;
    case: "decimal";
  } | {
 ...
 *
 * @generated from message buf.validate.DecimalRules
 */
export type DecimalRules = Message<"buf.validate.DecimalRules"> & {
  /**
...
/**
 * Describes the message buf.validate.DecimalRules.
 * Use `create(DecimalRulesSchema)` to create a new message.
 */
export const DecimalRulesSchema: GenMessage<DecimalRules> = /*@__PURE__*/
...
export const FieldPathElementSchema: GenMessage<FieldPathElement> = /*@__PURE__*/
  messageDesc(file_buf_validate_validate, 32);
