...
// @generated from file dev/cel/expr/explain.proto (package dev.cel.expr, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message dev.cel.expr.Explain
 * @deprecated
 */
export class Explain extends Message<Explain> {
   ...
   *
   * @generated from field: repeated dev.cel.expr.Explain.ExprStep expr_steps = 2;
   */
  ...
  static readonly typeName = "dev.cel.expr.Explain";
 ...
 *
 * @generated from message dev.cel.expr.Explain.ExprStep
 */
export class Explain_ExprStep extends Message<Explain_ExprStep> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Explain.ExprStep";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
