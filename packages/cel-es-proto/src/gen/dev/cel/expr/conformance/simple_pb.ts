...
// @generated from file dev/cel/expr/conformance/simple.proto (package dev.cel.expr.conformance, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3 } from "@bufbuild/protobuf";
import { Decl } from "../checked_pb";
import { ErrorSet, ExprValue, UnknownSet } from "../eval_pb";
 ...
 *
 * @generated from message dev.cel.expr.conformance.SimpleTestFile
 */
export class SimpleTestFile extends Message<SimpleTestFile> {
   ...
   *
   * @generated from field: repeated dev.cel.expr.conformance.SimpleTestSection section = 3;
   */
  ...
  static readonly typeName = "dev.cel.expr.conformance.SimpleTestFile";
 ...
 *
 * @generated from message dev.cel.expr.conformance.SimpleTestSection
 */
export class SimpleTestSection extends Message<SimpleTestSection> {
   ...
   * The contained tests.
   *
   * @generated from field: repeated dev.cel.expr.conformance.SimpleTest test = 3;
   */
  test: SimpleTest[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.conformance.SimpleTestSection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message dev.cel.expr.conformance.SimpleTest
 */
export class SimpleTest extends Message<SimpleTest> {
   ...
   *
   * @generated from field: repeated dev.cel.expr.Decl type_env = 6;
   */
  typeEnv: Decl[] = [];
   ...
   *
   * @generated from field: map<string, dev.cel.expr.ExprValue> bindings = 7;
   */
   ...
   *
   * @generated from oneof dev.cel.expr.conformance.SimpleTest.result_matcher
   */
  resultMatcher: {
    /**
     ...
     *
     * @generated from field: dev.cel.expr.Value value = 8;
     */
    value: Value;
    case: "value";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.ErrorSet eval_error = 9;
     */
    value: ErrorSet;
    case: "evalError";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.conformance.ErrorSetMatcher any_eval_errors = 10;
     */
     ...
     *
     * @generated from field: dev.cel.expr.UnknownSet unknown = 11;
     */
    value: UnknownSet;
    case: "unknown";
  } | {
     ...
     * (Using explicit message since oneof can't handle repeated.)
     *
     * @generated from field: dev.cel.expr.conformance.UnknownSetMatcher any_unknowns = 12;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.conformance.SimpleTest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message dev.cel.expr.conformance.ErrorSetMatcher
 */
export class ErrorSetMatcher extends Message<ErrorSetMatcher> {
  /**
   * Success if we match any of these sets.
   *
   * @generated from field: repeated dev.cel.expr.ErrorSet errors = 1;
   */
  errors: ErrorSet[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.conformance.ErrorSetMatcher";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.conformance.UnknownSetMatcher
 */
export class UnknownSetMatcher extends Message<UnknownSetMatcher> {
  /**
   * Success if we match any of these sets.
   *
   * @generated from field: repeated dev.cel.expr.UnknownSet unknowns = 1;
   */
  unknowns: UnknownSet[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.conformance.UnknownSetMatcher";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
