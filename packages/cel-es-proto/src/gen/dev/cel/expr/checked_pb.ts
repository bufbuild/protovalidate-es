...
// @generated from file dev/cel/expr/checked.proto (package dev.cel.expr, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Empty, Message, NullValue, proto3 } from "@bufbuild/protobuf";
import { Constant, Expr, SourceInfo } from "./syntax_pb";

/**
 * A CEL expression which has been successfully type checked.
 *
 * @generated from message dev.cel.expr.CheckedExpr
 */
export class CheckedExpr extends Message<CheckedExpr> {
   ...
   *   the message.
   *
   * @generated from field: map<int64, dev.cel.expr.Reference> reference_map = 2;
   */
   ...
   * space.
   *
   * @generated from field: map<int64, dev.cel.expr.Type> type_map = 3;
   */
   ...
   *
   * @generated from field: dev.cel.expr.SourceInfo source_info = 5;
   */
   ...
   *
   * @generated from field: dev.cel.expr.Expr expr = 4;
   */
  expr?: Expr;
  ...
  static readonly typeName = "dev.cel.expr.CheckedExpr";
 ...
 *
 * @generated from message dev.cel.expr.Type
 */
export class Type extends Message<Type> {
  /**
   * The kind of type.
   *
   * @generated from oneof dev.cel.expr.Type.type_kind
   */
  typeKind: {
    /**
     * Dynamic type.
     ...
     *
     * @generated from field: dev.cel.expr.Type.PrimitiveType primitive = 3;
     */
     ...
     *
     * @generated from field: dev.cel.expr.Type.PrimitiveType wrapper = 4;
     */
    value: Type_PrimitiveType;
    case: "wrapper";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.Type.WellKnownType well_known = 5;
     */
     ...
     *
     * @generated from field: dev.cel.expr.Type.ListType list_type = 6;
     */
    value: Type_ListType;
    case: "listType";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.Type.MapType map_type = 7;
     */
    value: Type_MapType;
    case: "mapType";
  } | {
     ...
     * Function type.
     *
     * @generated from field: dev.cel.expr.Type.FunctionType function = 8;
     */
     ...
     *
     * @generated from field: dev.cel.expr.Type type = 11;
     */
    value: Type;
    case: "type";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.Type.AbstractType abstract_type = 14;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Type";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * CEL primitive types.
 *
 * @generated from enum dev.cel.expr.Type.PrimitiveType
 */
...
proto3.util.setEnumType(Type_PrimitiveType, "dev.cel.expr.Type.PrimitiveType", [
 ...
 *
 * @generated from enum dev.cel.expr.Type.WellKnownType
 */
...
proto3.util.setEnumType(Type_WellKnownType, "dev.cel.expr.Type.WellKnownType", [
 ...
 *
 * @generated from message dev.cel.expr.Type.ListType
 */
export class Type_ListType extends Message<Type_ListType> {
  /**
   * The element type.
   *
   * @generated from field: dev.cel.expr.Type elem_type = 1;
   */
  elemType?: Type;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Type.ListType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Type.MapType
 */
export class Type_MapType extends Message<Type_MapType> {
  /**
   * The type of the key.
   *
   * @generated from field: dev.cel.expr.Type key_type = 1;
   */
  keyType?: Type;
   ...
   *
   * @generated from field: dev.cel.expr.Type value_type = 2;
   */
  valueType?: Type;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Type.MapType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Type.FunctionType
 */
export class Type_FunctionType extends Message<Type_FunctionType> {
  /**
   * Result type of the function.
   *
   * @generated from field: dev.cel.expr.Type result_type = 1;
   */
  resultType?: Type;
   ...
   *
   * @generated from field: repeated dev.cel.expr.Type arg_types = 2;
   */
  argTypes: Type[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Type.FunctionType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Type.AbstractType
 */
export class Type_AbstractType extends Message<Type_AbstractType> {
   ...
   *
   * @generated from field: repeated dev.cel.expr.Type parameter_types = 2;
   */
  parameterTypes: Type[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Type.AbstractType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Decl
 */
export class Decl extends Message<Decl> {
   ...
   * to the declaration in its container, as in `dev.cel.expr.Decl`.
   *
   * Declarations used as
   * [FunctionDecl.Overload][dev.cel.expr.Decl.FunctionDecl.Overload]
   * parameters may or may not have a name depending on whether the overload is
   * function declaration or a function definition containing a result
   * [Expr][dev.cel.expr.Expr].
   *
   * @generated from field: string name = 1;
   */
  name = "";
   ...
   *
   * @generated from oneof dev.cel.expr.Decl.decl_kind
   */
  declKind: {
    /**
     * Identifier declaration.
     *
     * @generated from field: dev.cel.expr.Decl.IdentDecl ident = 2;
     */
     ...
     *
     * @generated from field: dev.cel.expr.Decl.FunctionDecl function = 3;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Decl";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 * time.
 *
 * @generated from message dev.cel.expr.Decl.IdentDecl
 */
export class Decl_IdentDecl extends Message<Decl_IdentDecl> {
  /**
   * Required. The type of the identifier.
   *
   * @generated from field: dev.cel.expr.Type type = 1;
   */
  type?: Type;
   ...
   *
   * @generated from field: dev.cel.expr.Constant value = 2;
   */
  value?: Constant;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Decl.IdentDecl";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Decl.FunctionDecl
 */
export class Decl_FunctionDecl extends Message<Decl_FunctionDecl> {
  /**
   * Required. List of function overloads, must contain at least one overload.
   *
   * @generated from field: repeated dev.cel.expr.Decl.FunctionDecl.Overload overloads = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Decl.FunctionDecl";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Decl.FunctionDecl.Overload
 */
export class Decl_FunctionDecl_Overload extends Message<Decl_FunctionDecl_Overload> {
   ...
   *
   * This will be used by a [Reference][dev.cel.expr.Reference] to
  ...
  /**
   * List of function parameter [Type][dev.cel.expr.Type] values.
   *
   ...
   *
   * @generated from field: repeated dev.cel.expr.Type params = 2;
   */
  params: Type[] = [];
   ...
   *
   * @generated from field: dev.cel.expr.Type result_type = 4;
   */
  resultType?: Type;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Decl.FunctionDecl.Overload";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Reference
 */
export class Reference extends Message<Reference> {
   ...
   * [Decl.FunctionDecl][dev.cel.expr.Decl.FunctionDecl].
   *
   ...
   *
   * @generated from field: dev.cel.expr.Constant value = 4;
   */
  value?: Constant;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Reference";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
