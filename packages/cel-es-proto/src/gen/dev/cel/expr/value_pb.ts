...
// @generated from file dev/cel/expr/value.proto (package dev.cel.expr, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * range of values.
 *
 * @generated from message dev.cel.expr.Value
 */
export class Value extends Message<Value> {
  /**
   * Required. The valid kinds of values.
   *
   * @generated from oneof dev.cel.expr.Value.kind
   */
  kind: {
    /**
     * Null value.
     ...
     * An enum value.
     *
     * @generated from field: dev.cel.expr.EnumValue enum_value = 9;
     */
    value: EnumValue;
    case: "enumValue";
  } | {
     ...
     * Map value.
     *
     * @generated from field: dev.cel.expr.MapValue map_value = 11;
     */
    value: MapValue;
    case: "mapValue";
  } | {
     ...
     * List value.
     *
     * @generated from field: dev.cel.expr.ListValue list_value = 12;
     */
    value: ListValue;
    case: "listValue";
  } | {
  ...
  static readonly typeName = "dev.cel.expr.Value";
 ...
 * An enum value.
 *
 * @generated from message dev.cel.expr.EnumValue
 */
export class EnumValue extends Message<EnumValue> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.EnumValue";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.ListValue
 */
export class ListValue extends Message<ListValue> {
  /**
   * The ordered values in the list.
   *
   * @generated from field: repeated dev.cel.expr.Value values = 1;
   */
  values: Value[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.ListValue";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * required for use in a 'oneof'.
 *
 * @generated from message dev.cel.expr.MapValue
 */
export class MapValue extends Message<MapValue> {
   ...
   * cannot be used.
   *
   * @generated from field: repeated dev.cel.expr.MapValue.Entry entries = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.MapValue";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message dev.cel.expr.MapValue.Entry
 */
export class MapValue_Entry extends Message<MapValue_Entry> {
   ...
   *
   * @generated from field: dev.cel.expr.Value key = 1;
   */
  key?: Value;
   ...
   * The value.
   *
   * @generated from field: dev.cel.expr.Value value = 2;
   */
  value?: Value;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.MapValue.Entry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
