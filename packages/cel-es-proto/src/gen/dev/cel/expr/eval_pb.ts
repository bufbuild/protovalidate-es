...
// @generated from file dev/cel/expr/eval.proto (package dev.cel.expr, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message dev.cel.expr.EvalState
 */
export class EvalState extends Message<EvalState> {
  /**
   * The unique values referenced in this message.
   *
   * @generated from field: repeated dev.cel.expr.ExprValue values = 1;
   */
  values: ExprValue[] = [];
   ...
   * May be sparse.
   *
   * @generated from field: repeated dev.cel.expr.EvalState.Result results = 3;
   */
  ...
  static readonly typeName = "dev.cel.expr.EvalState";
 ...
 *
 * @generated from message dev.cel.expr.EvalState.Result
 */
export class EvalState_Result extends Message<EvalState_Result> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.EvalState.Result";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.ExprValue
 */
export class ExprValue extends Message<ExprValue> {
  /**
   * An expression can resolve to a value, error or unknown.
   *
   * @generated from oneof dev.cel.expr.ExprValue.kind
   */
  kind: {
    /**
     * @generated from field: dev.cel.expr.Value value = 1;
     */
    value: Value;
    case: "value";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.ErrorSet error = 2;
     */
    value: ErrorSet;
    case: "error";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.UnknownSet unknown = 3;
     */
    value: UnknownSet;
    case: "unknown";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.ExprValue";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.ErrorSet
 */
export class ErrorSet extends Message<ErrorSet> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.ErrorSet";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.UnknownSet
 */
export class UnknownSet extends Message<UnknownSet> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.UnknownSet";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
