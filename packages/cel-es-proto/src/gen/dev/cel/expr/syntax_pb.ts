...
// @generated from file dev/cel/expr/syntax.proto (package dev.cel.expr, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message dev.cel.expr.ParsedExpr
 */
export class ParsedExpr extends Message<ParsedExpr> {
  /**
   * The parsed expression.
   *
   * @generated from field: dev.cel.expr.Expr expr = 2;
   */
  expr?: Expr;
   ...
   *
   * @generated from field: dev.cel.expr.SourceInfo source_info = 3;
   */
  ...
  static readonly typeName = "dev.cel.expr.ParsedExpr";
 ...
 * [Decl][dev.cel.expr.Decl] provided at type-check for an expression to be
 ...
 * [Expr.Select][dev.cel.expr.Expr.Select] expression, and the function
 * declaration `startsWith`.
 *
 * @generated from message dev.cel.expr.Expr
 */
export class Expr extends Message<Expr> {
   ...
   *
   * @generated from oneof dev.cel.expr.Expr.expr_kind
   */
  exprKind: {
    /**
     * A constant expression.
     *
     * @generated from field: dev.cel.expr.Constant const_expr = 3;
     */
    value: Constant;
    case: "constExpr";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.Expr.Ident ident_expr = 4;
     */
    value: Expr_Ident;
    case: "identExpr";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.Expr.Select select_expr = 5;
     */
    value: Expr_Select;
    case: "selectExpr";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.Expr.Call call_expr = 6;
     */
    value: Expr_Call;
    case: "callExpr";
  } | {
     ...
     *
     * @generated from field: dev.cel.expr.Expr.CreateList list_expr = 7;
     */
     ...
     *
     * @generated from field: dev.cel.expr.Expr.CreateStruct struct_expr = 8;
     */
     ...
     *
     * @generated from field: dev.cel.expr.Expr.Comprehension comprehension_expr = 9;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Expr";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Expr.Ident
 */
export class Expr_Ident extends Message<Expr_Ident> {
   ...
   * [Expr.Select][dev.cel.expr.Expr.Select] expression.
   *
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Expr.Ident";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * A field selection expression. e.g. `request.auth`.
 *
 * @generated from message dev.cel.expr.Expr.Select
 */
export class Expr_Select extends Message<Expr_Select> {
   ...
   *
   * @generated from field: dev.cel.expr.Expr operand = 1;
   */
  operand?: Expr;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Expr.Select";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Expr.Call
 */
export class Expr_Call extends Message<Expr_Call> {
   ...
   * `x.f()`.
   *
   * @generated from field: dev.cel.expr.Expr target = 1;
   */
  target?: Expr;
   ...
   * The arguments.
   *
   * @generated from field: repeated dev.cel.expr.Expr args = 3;
   */
  args: Expr[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Expr.Call";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * `dyn([1, 'hello', 2.0])`
 *
 * @generated from message dev.cel.expr.Expr.CreateList
 */
export class Expr_CreateList extends Message<Expr_CreateList> {
  /**
   * The elements part of the list.
   *
   * @generated from field: repeated dev.cel.expr.Expr elements = 1;
   */
  elements: Expr[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Expr.CreateList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.Expr.CreateStruct
 */
export class Expr_CreateStruct extends Message<Expr_CreateStruct> {
   ...
   *
   * @generated from field: repeated dev.cel.expr.Expr.CreateStruct.Entry entries = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Expr.CreateStruct";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Represents an entry.
 *
 * @generated from message dev.cel.expr.Expr.CreateStruct.Entry
 */
export class Expr_CreateStruct_Entry extends Message<Expr_CreateStruct_Entry> {
   ...
   * The `Entry` key kinds.
   *
   * @generated from oneof dev.cel.expr.Expr.CreateStruct.Entry.key_kind
   */
  keyKind: {
    /**
     ...
     *
     * @generated from field: dev.cel.expr.Expr map_key = 3;
     */
    value: Expr;
    case: "mapKey";
  } | { case: undefined; value?: undefined } = { case: undefined };
   ...
   *
   * @generated from field: dev.cel.expr.Expr value = 4;
   */
  value?: Expr;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Expr.CreateStruct.Entry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * ```
 *
 * @generated from message dev.cel.expr.Expr.Comprehension
 */
export class Expr_Comprehension extends Message<Expr_Comprehension> {
   ...
   *
   * @generated from field: dev.cel.expr.Expr iter_range = 2;
   */
  iterRange?: Expr;
   ...
   *
   * @generated from field: dev.cel.expr.Expr accu_init = 4;
   */
  accuInit?: Expr;
   ...
   *
   * @generated from field: dev.cel.expr.Expr loop_condition = 5;
   */
  loopCondition?: Expr;
   ...
   *
   * @generated from field: dev.cel.expr.Expr loop_step = 6;
   */
  loopStep?: Expr;
   ...
   * Computes the result.
   *
   * @generated from field: dev.cel.expr.Expr result = 7;
   */
  result?: Expr;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Expr.Comprehension";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * contain [Expr][dev.cel.expr.Expr] elements which require evaluation and
 * are thus not constant.
 *
 * Examples of constants include: `"hello"`, `b'bytes'`, `1u`, `4.2`, `-2`,
 * `true`, `null`.
 *
 * @generated from message dev.cel.expr.Constant
 */
export class Constant extends Message<Constant> {
  /**
   * Required. The valid constant kinds.
   *
   * @generated from oneof dev.cel.expr.Constant.constant_kind
   */
  constantKind: {
    /**
     * null value.
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.Constant";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message dev.cel.expr.SourceInfo
 */
export class SourceInfo extends Message<SourceInfo> {
   ...
   *
   * @generated from field: map<int64, dev.cel.expr.Expr> macro_calls = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dev.cel.expr.SourceInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
