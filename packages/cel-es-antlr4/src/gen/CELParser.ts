...
export class ListInitContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CELParser.RULE_listInit; }
	// @Override
	public enterRule(listener: CELListener): void {
...
export class OptFieldContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CELParser.RULE_optField; }
	// @Override
	public enterRule(listener: CELListener): void {
...
export class OptExprContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CELParser.RULE_optExpr; }
	// @Override
	public enterRule(listener: CELListener): void {
