...
// @generated from file store/v1/order.proto (package store.v1, syntax proto3)
/* eslint-disable */
 ...
 */
export type Order = Message<"store.v1.Order"> & {
  /**
   ...
   * to createValidator().
   *
   * @generated from field: store.v1.User user = 2;
   */
  user?: User | undefined;
};
 ...
 * @generated from message store.v1.Order
 */
export type OrderValid = Message<"store.v1.Order"> & {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
...
/**
 * Describes the message store.v1.Order.
...
/**
 * @generated from message store.v1.User
 */
export type User = Message<"store.v1.User"> & {
  /**
...
/**
 * Describes the message store.v1.User.
