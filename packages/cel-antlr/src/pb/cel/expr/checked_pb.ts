...
export class CheckedExpr extends Message<CheckedExpr> {
  ...
  static readonly typeName = "cel.expr.CheckedExpr";
...
export class Type extends Message<Type> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Type";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
proto3.util.setEnumType(Type_PrimitiveType, "cel.expr.Type.PrimitiveType", [
...
proto3.util.setEnumType(Type_WellKnownType, "cel.expr.Type.WellKnownType", [
...
export class Type_ListType extends Message<Type_ListType> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Type.ListType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Type_MapType extends Message<Type_MapType> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Type.MapType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Type_FunctionType extends Message<Type_FunctionType> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Type.FunctionType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Type_AbstractType extends Message<Type_AbstractType> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Type.AbstractType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Decl extends Message<Decl> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Decl";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class Decl_IdentDecl extends Message<Decl_IdentDecl> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Decl.IdentDecl";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Decl_FunctionDecl extends Message<Decl_FunctionDecl> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Decl.FunctionDecl";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Decl_FunctionDecl_Overload extends Message<Decl_FunctionDecl_Overload> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Decl.FunctionDecl.Overload";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Reference extends Message<Reference> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.Reference";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
