...
// @generated from file cel/expr/conformance/simple.proto (package cel.expr.conformance, syntax proto3)
/* eslint-disable */
 ...
 *
 * @generated from message cel.expr.conformance.SimpleTestFile
 */
export class SimpleTestFile extends Message<SimpleTestFile> {
   ...
   *
   * @generated from field: repeated cel.expr.conformance.SimpleTestSection section = 3;
   */
  ...
  static readonly typeName = "cel.expr.conformance.SimpleTestFile";
 ...
 *
 * @generated from message cel.expr.conformance.SimpleTestSection
 */
export class SimpleTestSection extends Message<SimpleTestSection> {
   ...
   * The contained tests.
   *
   * @generated from field: repeated cel.expr.conformance.SimpleTest test = 3;
   */
  test: SimpleTest[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.conformance.SimpleTestSection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message cel.expr.conformance.SimpleTest
 */
export class SimpleTest extends Message<SimpleTest> {
   ...
   *
   * @generated from oneof cel.expr.conformance.SimpleTest.result_matcher
   */
  resultMatcher: {
    /**
     ...
     *
     * @generated from field: cel.expr.conformance.ErrorSetMatcher any_eval_errors = 10;
     */
     ...
     * (Using explicit message since oneof can't handle repeated.)
     *
     * @generated from field: cel.expr.conformance.UnknownSetMatcher any_unknowns = 12;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.conformance.SimpleTest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message cel.expr.conformance.ErrorSetMatcher
 */
export class ErrorSetMatcher extends Message<ErrorSetMatcher> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.conformance.ErrorSetMatcher";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message cel.expr.conformance.UnknownSetMatcher
 */
export class UnknownSetMatcher extends Message<UnknownSetMatcher> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cel.expr.conformance.UnknownSetMatcher";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
